...
void Session::PacketHandler()
{
	...
	case MyPacket::MessageType::PKT_CS_LOGIN:
	{
		...
		google::protobuf::io::ArrayOutputStream outputArrayStream( &mSendBuffer, mSendBuffer.GetFreeSpaceSize() );
		google::protobuf::io::CodedOutputStream outputCodedStream(&outputArrayStream);
...
// 		if ( false == PostSend( , loginResult.ByteSize() + MessageHeaderSize ) )
// 			break;
